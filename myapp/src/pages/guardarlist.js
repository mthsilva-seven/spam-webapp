...
export default function ListUserPage() {
  ...
  function getSetores() {
    axios.get('http://192.168.88.215:5000/listsetores', {
      params: {
        page: activePage,
  ...
  function deleteSetor(id) {
    axios.delete(`http://192.168.88.215:5000/setordelete/${id}`).then(function (response) {
  ...
  const handleDownload = async () => {
    try {
      const response = await fetch('http://192.168.88.215:5000/setordownload', {
        method: 'GET',
        headers: {
